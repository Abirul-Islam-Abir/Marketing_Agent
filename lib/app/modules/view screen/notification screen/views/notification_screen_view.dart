...
class NotificationScreenView extends StatelessWidget {
  ...
  @override
  final _contoller = Get.put(NotificationScreenController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: GetBuilder<NotificationScreenController>(builder: (controller) {
...
// Use formatDate function in your NotificationCard widget
