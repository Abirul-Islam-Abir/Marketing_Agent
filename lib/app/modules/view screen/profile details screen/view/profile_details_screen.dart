...
class ProfileDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ProfileScreenController>(builder: (c) {
        final data = c.userProfileList;
          ...
          child: Column(
            ...
            children: [
              ...
              ProfileDetailsCardWithUpload(
                  showTap: () {
                    Get.to(() => PdfView(url: c.userProfileList['nid_pdf']));
                  },
              ...
              ProfileDetailsCardWithUpload(
                  showTap: () {
                    Get.to(
                        () => PdfView(url: c.userProfileList['passport_pdf']));
                  },
